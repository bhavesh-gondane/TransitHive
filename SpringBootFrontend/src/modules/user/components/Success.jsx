      ...
      .then((data) => {
        ...
        if (data.transactionId) {
          ...
          axios.post('http://localhost:8080/payments', {
                    // Assuming you get this from the backend response
